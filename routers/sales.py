...
async def create_sale(
    ...
    buy_price: str = Form(...),
    ship_date: str = Form(...),
    estimated_delivery: str = Form(None),
    estimated_payout_date: str = Form(None),
    sale_date: str = Form(...),
    buyer_name: str = Form(...),
    ...
    new_sale = Sale(
        ...
        estimated_delivery=date.fromisoformat(estimated_delivery) if estimated_delivery else None,
        estimated_payout_date=date.fromisoformat(estimated_payout_date) if estimated_payout_date else None,
...
async def edit_sale(
    ...
    sale.ship_date = date.fromisoformat(ship_date)
    sale.estimated_delivery = date.fromisoformat(estimated_delivery) if estimated_delivery else None
    sale.estimated_payout_date = date.fromisoformat(estimated_payout_date) if estimated_payout_date else None
